...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-4 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p class="mb-8 leading-relaxed" style="color:gray;"><?=$desc?></p>
      
      <Button style="background:black;color:white;borderradius:30px;padding:0.3rem 2rem;"><?=$Button?></Button><br><br><br>
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" style="width:80%;height:80%" alt="hero" src="./image/<?=$img?>">
    </div>
  </div>
</section>